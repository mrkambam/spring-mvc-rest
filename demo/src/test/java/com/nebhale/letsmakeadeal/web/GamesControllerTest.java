...
public final class GamesControllerTest {
    ...
    private final Game game;
    {
        ...
        doors.add(new Door(3L, DoorContent.NAZ));
    ...
    private final MockMvc mockMvc = standaloneSetup(
        new GamesController(gameRepository, new GameResourceAssembler(), new DoorsResourceAssembler(new DoorResourceAssembler()), new GamesResourceAssembler(new GameResourceAssembler()))) //
    .build();

    @Test
    public void createGame() throws Exception {
    	Mockito.when(this.gameRepository.create()).thenReturn(game);
    ...
    public void destroyGame() throws Exception {
        ...
        Mockito.verify(this.gameRepository).remove(0L);
    }

    @Test
    public void destroyGameGameDoesNotExist() throws Exception {
    	Mockito.doThrow(new GameDoesNotExistException(0L)).when(this.gameRepository).remove(0L);
