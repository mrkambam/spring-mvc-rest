...
final class GamesController {
    ...
    private final GamesResourceAssembler gamesResourceAssembler;
    
    @Autowired
    GamesController(GameRepository gameRepository, GameResourceAssembler gameResourceAssembler, DoorsResourceAssembler doorsResourceAssembler, GamesResourceAssembler gamesResourceAssembler) {
        this.gameRepository = gameRepository;
        this.gameResourceAssembler = gameResourceAssembler;
        this.doorsResourceAssembler = doorsResourceAssembler;
        this.gamesResourceAssembler = gamesResourceAssembler;
    }
    
    @RequestMapping(method = RequestMethod.GET, value = "", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_XML_VALUE })
    ResponseEntity<GamesResource> listGames() {
    	List<Game> games = this.gameRepository.list();
    	GamesResource resource = gamesResourceAssembler.toResource(games);
    	return new ResponseEntity<GamesResource>(resource, HttpStatus.OK);
    }
