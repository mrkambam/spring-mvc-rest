...
public final class DoorTest {
    ...
    private final Door door = new Door(1L, DoorContent.NAZ);

    @Test
    public void test() {
        assertEquals(Long.valueOf(1), this.door.getId());
        assertEquals(DoorContent.NAZ, this.door.peekContent());
        ...
        assertEquals(DoorContent.NAZ, this.door.getContent());
    }
